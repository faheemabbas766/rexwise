 ...
 */
//braine_load_default_hooks
function braine_load_default_hooks() {

	$config = braine_WSH()->config( 'default' );
...
/**
 * [braine_main_header_area description]
 *
 * @return [type] [description]
 */

//braine_main_header_area
function braine_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		braine_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		braine_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		braine_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		braine_template_load( 'templates/header/header_v4.php' );
	} else {
		braine_template_load( 'templates/header/header_v4.php' );
	}
}
...
/**
 * [braine_main_footer_area description]
 *
 * @return [type] [description]
 */
//braine_main_footer_area
function braine_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		braine_template_load( 'templates/footer/default-footer.php' );
	} elseif ( $footer == 'footer_v2' ) {
		braine_template_load( 'templates/footer/footer_v2.php' );
	} elseif ( $footer == 'footer_v3' ) {
		braine_template_load( 'templates/footer/footer_v3.php' );
	} elseif ( $footer == 'footer_v4' ) {
		braine_template_load( 'templates/footer/footer_v4.php' );
	} else {
		braine_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [braine_sidebar description]
 *
 * @return [type] [description]
 */
//braine_sidebar
function braine_sidebar( $data ) {

	braine_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [braine_banner description]
 *
 * @return [type] [description]
 */
//braine_banner
function braine_banner( $data ) {

	braine_template_load( 'templates/banner/banner.php', compact( 'data' ) );
