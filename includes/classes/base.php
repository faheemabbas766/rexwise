...
use BRAINE\Includes\Classes\Header_Enqueue;

use BRAINE\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['braine_base'] ) ) {

			return $GLOBALS['braine_base'];
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'braine' . '_options-mods' );



		$dn = braine_dot( $options );
