            ...
            <div class="inner-container">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="outer-box d-flex align-items-center flex-wrap">
						<?php if($options->get('show_btn_info_v4') || $options->get('show_btn_info2_v4')){ ?>
                        <!-- Button Box -->
                        <div class="main-header_buttons">
                            <?php if($options->get('show_btn_info_v4')){ ?>
                            <a href="<?php echo esc_url($options->get('btn_link_v4'), true); ?>" class="template-btn btn-style-two">
                                <span class="btn-wrap">
                                    <span class="text-one"><?php echo wp_kses($options->get('btn_title_v4'), true); ?></span>
                                    <span class="text-two"><?php echo wp_kses($options->get('btn_title_v4'), true); ?></span>
                                </span>
                            </a>
                            <?php } ?>
                            <?php if($options->get('show_btn_info2_v4')){ ?>
                            <a href="<?php echo esc_url($options->get('btn_link2_v4'), true); ?>" class="template-btn btn-style-one">
                                <span class="btn-wrap">
                                    <span class="text-one"><?php echo wp_kses($options->get('btn_title2_v4'), true); ?></span>
                                    <span class="text-two"><?php echo wp_kses($options->get('btn_title2_v4'), true); ?></span>
                                </span>
                            </a>
                            <?php } ?>
                        </div>
