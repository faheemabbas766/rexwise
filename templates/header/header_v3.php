            ...
            <div class="inner-container">
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    ...
                    <div class="outer-box d-flex align-items-center flex-wrap">
						<?php
							if( $options->get( 'show_header_social_icon_v3' )):
						?>
                        <!-- Social Box -->
						...
						<?php endif; ?>
                        <?php if($options->get('show_btn_info_v3') || $options->get('show_btn_info2_v3')){ ?>
                        <!-- Button Box -->
                        <div class="main-header_buttons">
							<?php if($options->get('show_btn_info_v3')){ ?>
                            <a href="<?php echo esc_url($options->get('btn_link_v3'), true); ?>" class="template-btn btn-style-two">
                                <span class="btn-wrap">
                                    <span class="text-one"><?php echo wp_kses($options->get('btn_title_v3'), true); ?></span>
                                    <span class="text-two"><?php echo wp_kses($options->get('btn_title_v3'), true); ?></span>
                                </span>
                            </a>
                            <?php } ?>
                            <?php if($options->get('show_btn_info2_v3')){ ?>
                            <a href="<?php echo esc_url($options->get('btn_link2_v3'), true); ?>" class="template-btn btn-style-one">
                                <span class="btn-wrap">
                                    <span class="text-one"><?php echo wp_kses($options->get('btn_title2_v3'), true); ?></span>
                                    <span class="text-two"><?php echo wp_kses($options->get('btn_title2_v3'), true); ?></span>
                                </span>
                            </a>
                            <?php } ?>
						</div>
